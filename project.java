...
import java.awt.event.*;// for event handling over the button

public class project extends JFrame implements ActionListener {
       
    project(){
        setSize(2000,1100);// size of the window
        getContentPane().setBackground(Color.WHITE);
        
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("payroll_system\\icon\\payroll.jpg"));
        ...
        t1.setIcon(new ImageIcon(ClassLoader.getSystemResource("payroll_system\\icon\\New.png")));
        ...
        t3.setMnemonic('S');
        t3.setIcon(new ImageIcon(ClassLoader.getSystemResource("payroll_system\\icon\\schedreport.png")));
        ...
        t4.setMnemonic('L');
        t4.setIcon(new ImageIcon(ClassLoader.getSystemResource("payroll_system\\icon\\newinvoice.png")));
        ...
        s1.setMnemonic('U');
        s1.setIcon(new ImageIcon(ClassLoader.getSystemResource("payroll_system\\icon\\EditOpen.png")));
        ...
        s2.setMnemonic('p');
        s2.setIcon(new ImageIcon(ClassLoader.getSystemResource("payroll_system\\icon\\empreport.png")));
        ...
        s3.setMnemonic('T');
        s3.setIcon(new ImageIcon(ClassLoader.getSystemResource("payroll_system\\icon\\EXPENSE.PNG")));
        ...
        p1.setMnemonic('P');
        p1.setIcon(new ImageIcon(ClassLoader.getSystemResource("payroll_system\\icon\\payments.png")));
        ...
        p2.setMnemonic('L');
        p2.setIcon(new ImageIcon(ClassLoader.getSystemResource("payroll_system\\icon\\empreport.png")));
        ...
        u1.setIcon(new ImageIcon(ClassLoader.getSystemResource("payroll_system\\icon\\New.png")));
        ...
        u2.setIcon(new ImageIcon(ClassLoader.getSystemResource("payroll_system\\icon\\calc.png")));
        ...
        u3.setIcon(new ImageIcon(ClassLoader.getSystemResource("payroll_system\\icon\\explorer.jpg")));
        ...
        m8i1.setMnemonic('X');
        m8i1.setIcon(new ImageIcon(ClassLoader.getSystemResource("payroll_system\\icon\\exit.PNG")));
